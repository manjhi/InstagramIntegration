        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    writer.flush();
                    String response = CommonUtils.streamToString(urlConnection
                            .getInputStream());
                    ...
                    String Picture=jsonObj.getJSONObject("user").getString("profile_picture");

                    App.getAppPreferences().setInstaId(id);
                    App.getAppPreferences().setInstaUserName(name);
                    App.getAppPreferences().setInstaUserPicture(Picture);
